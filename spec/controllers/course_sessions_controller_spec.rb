...
describe CourseSessionsController do
  ...
  # CourseSession. As you add validations to CourseSession, be sure to
  ...
  # CourseSessionsController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "GET index" do
    it "assigns all course_sessions as @course_sessions" do
      course_session = CourseSession.create! valid_attributes
  ...
  describe "GET show" do
    it "assigns the requested course_session as @course_session" do
      course_session = CourseSession.create! valid_attributes
      get :show, {:id => course_session.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested course_session as @course_session" do
      course_session = CourseSession.create! valid_attributes
      get :edit, {:id => course_session.to_param}, valid_session
      assigns(:course_session).should eq(course_session)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new CourseSession" do
        expect {
          post :create, {:course_session => valid_attributes}, valid_session
      ...
      it "redirects to the created course_session" do
        post :create, {:course_session => valid_attributes}, valid_session
        response.should redirect_to(CourseSession.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved course_session as @course_session" do
        ...
        post :create, {:course_session => { "course_id" => "invalid value" }}, valid_session
        assigns(:course_session).should be_a_new(CourseSession)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested course_session" do
        ...
        CourseSession.any_instance.should_receive(:update_attributes).with({ "course_id" => "1" })
        put :update, {:id => course_session.to_param, :course_session => { "course_id" => "1" }}, valid_session
      end

      it "assigns the requested course_session as @course_session" do
        course_session = CourseSession.create! valid_attributes
        put :update, {:id => course_session.to_param, :course_session => valid_attributes}, valid_session
        assigns(:course_session).should eq(course_session)
      end
      ...
      it "redirects to the course_session" do
        course_session = CourseSession.create! valid_attributes
        put :update, {:id => course_session.to_param, :course_session => valid_attributes}, valid_session
        response.should redirect_to(course_session)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the course_session as @course_session" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        CourseSession.any_instance.stub(:save).and_return(false)
        put :update, {:id => course_session.to_param, :course_session => { "course_id" => "invalid value" }}, valid_session
        assigns(:course_session).should eq(course_session)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested course_session" do
      course_session = CourseSession.create! valid_attributes
      expect {
        delete :destroy, {:id => course_session.to_param}, valid_session
      }.to change(CourseSession, :count).by(-1)
    end
    ...
    it "redirects to the course_sessions list" do
      course_session = CourseSession.create! valid_attributes
      delete :destroy, {:id => course_session.to_param}, valid_session
      response.should redirect_to(course_sessions_url)
    end
  end
